...
<div style="max-width: 500px; margin: 100px auto;">
    <h1 style="font-size: 32px; color: #333; margin-bottom: 30px; text-align: left;">
        AIWA FA<span id="quick-login-r" style="cursor: pointer; color: #0066cc; text-decoration: underline; user-select: none;" title="クリックして自動ログイン">R</span>M
    </h1>
...
<script>
document.getElementById('quick-login-r').addEventListener('click', function() {
